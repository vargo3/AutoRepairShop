...
CREATE TABLE public.cfg_user_role (
    cfg_user_role_id INT NOT NULL GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE public.cfg_make (
    cfg_make_id INT NOT NULL GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,

    name VARCHAR(64) NOT NULL UNIQUE
);

CREATE TABLE public.cfg_model (
    cfg_model_id INT NOT NULL GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,

    cfg_make_id INT,
    name VARCHAR(64) NOT NULL,

    CONSTRAINT fk_model__make_id FOREIGN KEY(cfg_make_id) REFERENCES cfg_make(cfg_make_id)
);

CREATE TABLE public.cfg_status (
    cfg_status_id INT NOT NULL GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE public.account (
    account_id INT NOT NULL GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE public.vehicle (
    vehicle_id INT NOT NULL GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    ...
    CONSTRAINT fk_vehicle__cfg_model_id FOREIGN KEY(cfg_model_id) REFERENCES cfg_model(cfg_model_id)
);

CREATE TABLE public.work_order (
    work_order_id INT NOT NULL GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE public.work_order_expense (
    work_order_expense_id INT NOT NULL GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
